...
//     };
//
//     var program = this.props.name;
//     axios.get("https://zagsabroad-backend.herokuapp.com/programcourses", program).then((res) => {
//       // let courses = [];
...
//       }
//     }
//     this.getCourses(); // Update course results based on new state
...
//         </div>
//         <div style={{marginTop: '30px', marginLeft: '100px', width: '500px'}}>
//           <DropdownTextField
...
//           {this.state.courseList.map(program => {
//             return (
