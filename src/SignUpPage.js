    ...
    return (
      <div style={{textAlign: 'center'}}>
        ...
        <Dialog open={this.state.showEmailSentPrompt}>
          <DialogTitle>Please check your email to verify your account! (Make sure to also check your junk/spam folders!) (also check your junk/spam folder) </DialogTitle>
          <div style={{margin: '0 auto', marginBottom: '5px'}}>
